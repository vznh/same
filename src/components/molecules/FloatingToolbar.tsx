...
export default function FloatingToolbar({
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 pointer-events-none">
      <div className="relative w-[520px] h-16 flex items-center justify-center">
        {/* Bar background */}
        <div className="absolute inset-0 rounded-[16px] bg-black/10 translate-y-12" />

        {/* Icon row - slightly above the bar */}
        <div className="relative z-10 flex items-center gap-20 pointer-events-auto -translate-y-4">
          {/* Image */}
          <div className="relative group">
            ...
            >
              <Image src={"/same.png"} alt={"Same's logo."} width={39} height={39} />
            </button>
          ...
          <div className="relative group">
            <button
              aria-label="Add"
              onClick={onAddClick}
              className="w-8 h-8 rounded-sm bg-gray-300/70 hover:bg-gray-300 text-gray-800 flex items-center justify-center shadow-sm"
            >
